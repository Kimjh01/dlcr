...
from train import train_cal, train_cal_with_memory, train_cal_generated_data
...
def parse_option():
    ...
    parser.add_argument('--gen_path', type=str, help="your generated data path ")
...
def main(config):
    ...
    for epoch in range(start_epoch, config.TRAIN.MAX_EPOCH):
        ...
        if config.LOSS.CAL == 'calwithmemory':
            ...
            if config.DATA.USE_GENERATED:
                train_cal_generated_data(config, epoch, model, classifier, clothes_classifier, criterion_cla,
                                             criterion_pair,
